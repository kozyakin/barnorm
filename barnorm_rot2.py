...
Last updated on Sat Sep 17 13:33:35 2022 +0300.
...
"""
fig.savefig(f'bnorm-{THETA0:.2f}-{THETA1:.2f}.pdf', bbox_inches='tight')
fig2.savefig(f'sfunc-{THETA0:.2f}-{THETA1:.2f}.pdf', bbox_inches='tight')
"""
