...
t_plot_ang_fun2 = time.time() - t_tick
pyplot.show()
...
fig.savefig('barnorm-%.2f-%.2f-%.2f-%.2f-%.2f-%.2f.pdf'
            % (ALPHA, AAA, BBB, BETA, CCC, DDD),
            bbox_inches='tight')
fig2.savefig('anglefun-%.2f-%.2f-%.2f-%.2f-%.2f-%.2f.pdf'
             % (ALPHA, AAA, BBB, BETA, CCC, DDD),
             bbox_inches='tight')
fig3.savefig('anglefun2-%.2f-%.2f-%.2f-%.2f-%.2f-%.2f.pdf'
             % (ALPHA, AAA, BBB, BETA, CCC, DDD),
             bbox_inches='tight')
...
t_total = (t_ini + t_plot_ang_fun + t_plot_ang_fun2 + t_traj_plot +
