...
Last updated on Thu Dec 16 15:55:00 2021.
...
A0 = np.array([[2. * COS_A0, -1.], [1., 0.]])
A1 = np.array([[0., 1.], [-1., 2. * COS_A1]])
A0T = np.transpose(A0)
A1T = np.transpose(A1)
...
"""
fig.savefig('barnorm-%.2f-%.2f.pdf'
            % (THETA0, THETA1), bbox_inches='tight')
fig2.savefig('anglefun-%.2f-%.2f.pdf'
             % (THETA0, THETA1), bbox_inches='tight')
"""
